CREATE SCHEMA caipora;

-- caipora.conf_grupo_consumidor_topico definition

-- Drop table

-- DROP TABLE caipora.conf_grupo_consumidor_topico;
...
-- DROP TABLE caipora.conf_topico;
...
CREATE TABLE caipora.conf_topico (
	...
	tamanho_paginacao int4 NOT NULL DEFAULT 10, -- Tamanho da paginacao entre a tabela original e a tabela de consumo do grupo. Define a quantidade de registros que serao movidos entre essas tabelas a cada vez que a paginacao for necessaria.
	tempo_max_pendente_seg int4 NOT NULL DEFAULT 10, -- Define a quantidade de particoes para um evento. Partições permitem o consumo em paralelo de eventos entre os consumidores.
...
COMMENT ON COLUMN caipora.conf_topico.tamanho_paginacao IS 'Tamanho da paginacao entre a tabela original e a tabela de consumo do grupo. Define a quantidade de registros que serao movidos entre essas tabelas a cada vez que a paginacao for necessaria.';
COMMENT ON COLUMN caipora.conf_topico.tempo_max_pendente_seg IS 'Define a quantidade de particoes para um evento. Partições permitem o consumo em paralelo de eventos entre os consumidores.';
...
-- DROP TABLE caipora.evento_consumidor_topico;
...
CREATE TABLE caipora.evento_consumidor_topico (
	...
	sequencial_balanceamento int8 NOT NULL, -- Utilizado para sequenciar a criacao de eventos do consumidor e permitir balanceamento a estrutura de consumo
	tx_descricao_atualizacao varchar NULL,
	id_consumidor varchar NULL,
...
COMMENT ON COLUMN caipora.evento_consumidor_topico.sequencial_balanceamento IS 'Utilizado para sequenciar a criacao de eventos do consumidor e permitir balanceamento a estrutura de consumo';
...
-- DROP TABLE caipora.subscricoes;
...
-- DROP TABLE caipora.subscricoes_particoes;
...
-- DROP TABLE caipora.evento_original_topico;
...
CREATE TABLE caipora.evento_original_topico (
	...
	CONSTRAINT evento_original_topico_pk PRIMARY KEY (id_evento_offset),
...
CREATE SEQUENCE caipora.evento_sequence
	MAXVALUE 9999999999
	START 1
	CYCLE;
