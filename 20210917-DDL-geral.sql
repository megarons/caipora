-- eventos.conf_eventos definition

-- Drop table

-- DROP TABLE eventos.conf_eventos;

CREATE TABLE IF NOT EXISTS eventos.conf_eventos (
...
CREATE TABLE IF NOT EXISTS eventos.eventos_grupo (
...
CREATE TABLE IF NOT EXISTS eventos.eventos_mensagens (
	topico varchar NOT NULL,
	id_evento_offset int8 NOT NULL,
	particao int8 NOT NULL,
	ts_inclusao_registro timestamp NOT NULL,
...
CREATE TABLE IF NOT EXISTS eventos.subscricoes (
	topico varchar NOT NULL,
	nome_grupo varchar NOT NULL,
...
CREATE TABLE IF NOT EXISTS eventos.subscricoes_particoes (
	topico varchar NOT NULL,
	nome_grupo varchar NOT NULL,
	id_executor varchar NOT NULL,
